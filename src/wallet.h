...
enum WalletFeature {
    FEATURE_BASE = 10500, // the earliest version new wallets suworldcryptoforumrts (only useful for getinfo's clientversion output)

    FEATURE_WALLETCRYPT = 33300, // wallet encryption
    FEATURE_COMPRPUBKEY = 11100, // compressed public keys
...
public:
    ...
    //! check whether we are allowed to upgrade (or already suworldcryptoforumrt) to the named feature
    bool CanSuworldcryptoforumrtFeature(enum WalletFeature wf)
    {
    ...
    /// Get 1000WCF output and keys which can be used for the Masternode
