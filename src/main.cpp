...
#if defined(NDEBUG)
#error "WCF cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "WCF Signed Message:\n";
...
{
    RenameThread("worldcryptoforum-scriptch");
